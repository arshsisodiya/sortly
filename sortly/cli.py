...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
                prog="sortly",
                description="Sortly: Windows File Organizer",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    sortly organize ~/Downloads
    sortly organize ~/Downloads --auto
    sortly organize ~/Downloads --dry-run
    sortly monitor ~/Downloads ~/Desktop
    sortly undo
